...
namespace IoTNightlight
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private const string IOT_HUB_CONN_STRING = "HostName=suicidehub.azure-devices.net;DeviceId=hellboy;SharedAccessKey=vd79eZ1AI9PNhBZ6rkP1rvlIA1ixbdZWMY3eWMgyK6I=";
        // Use the name of your Azure IoT device here - this should be the same as the name in the connections string
        private const string IOT_HUB_DEVICE = "hellboy";
        // Provide a short description of the location of the device, such as 'Home Office' or 'Garage'
        private const string IOT_HUB_DEVICE_LOCATION = "Garage";
        ...
        private async Task InitSpiAsync()
        {
            try
            {
                ...
                settings.ClockFrequency = 1300000; // Set the clock frequency at or slightly below the specified rate speed
